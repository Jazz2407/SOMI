...
# REMOVED: from langchain.storage import LocalFileStore
...
class VectorStore:
    ...
    # CHANGED: LocalFileStore to InMemoryStore
    def load_vectorstore(self) -> Tuple[QdrantVectorStore, InMemoryStore]:
        ...
        # CHANGED: Document storage to InMemoryStore
    ...
    def create_vectorstore(
        ...
        # CHANGED: Document storage for parent documents to InMemoryStore
        docstore = InMemoryStore()
